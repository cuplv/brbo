...
tools_jar="/usr/lib/jvm/jdk1.8.0_291/lib/tools.jar"
...
set -x
time java -Dlog4j.configurationFile="src/resources/log4j2.properties" -cp $classpath brbo.BrboMain "${@:1}" --icra-path /home/sas-artifact-41/icra/icra

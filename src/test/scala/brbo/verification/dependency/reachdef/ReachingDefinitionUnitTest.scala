  ...
  val reachingDefinitionUnitTest: List[TestCaseJavaProgram] = {
    ...
    val test01ExpectedOutput =
      """(R + a) (`R + a`) -> (Don't care)
        ...
        |R (`R`) -> (Don't care)
        |R (`R`) -> (Don't care)
        |R (`int R = 0`) -> (`a` in `UniqueNode(a = 2)`, `l` (input), `m` (input), `n` (input))
        |R = (R + a) (`R = R + a`) -> (`R` in `UniqueNode(R = 0)`, `a` in `UniqueNode(a = (a + 1))`, `l` (input), `m` (input), `n` (input))
        |R = 0 (`int R = 0`) -> (`a` in `UniqueNode(a = 2)`, `l` (input), `m` (input), `n` (input))
        |a (`a`) -> (Don't care)
        |a (`a`) -> (Don't care)
        |a (`a`) -> (Don't care)
        |a (`int a = 2`) -> (`l` (input), `m` (input), `n` (input))
        |a = (a + 1) (`a = a + 1`) -> (`R` in `UniqueNode(R = 0)`, `a` in `UniqueNode(a = 2)`, `l` (input), `m` (input), `n` (input))
    ...
    val test02ExpectedOutput =
      """(R + a) (`R + a`) -> (Don't care)
        ...
        |R (`R`) -> (Don't care)
        |R (`R`) -> (Don't care)
        |R (`int R = 0`) -> (`a` in `UniqueNode(a = 0)`, `l` (input), `m` (input), `n` (input))
        |R = (R + a) (`R = R + a`) -> (`R` in `UniqueNode(R = 0)`, `a` in `UniqueNode(a = 0)`, `l` (input), `m` (input), `n` (input))
        |R = 0 (`int R = 0`) -> (`a` in `UniqueNode(a = 0)`, `l` (input), `m` (input), `n` (input))
        |a (`a`) -> (Don't care)
        |a (`a`) -> (Don't care)
    ...
    val test03ExpectedOutput =
      """(R + a) (`R + a`) -> (Don't care)
        ...
        |R (`R`) -> (Don't care)
        |R (`int R = 0`) -> (`a` in `UniqueNode(a = 0)`, `l` (input), `m` (input), `n` (input))
        |R = (R + a) (`R = R + a`) -> (`R` in `UniqueNode(R = 0)`, `a` in `UniqueNode(a = (a + n))`, `a` in `UniqueNode(a = 0)`, `l` (input), `m` (input), `n` (input))
        |R = 0 (`int R = 0`) -> (`a` in `UniqueNode(a = 0)`, `l` (input), `m` (input), `n` (input))
        |a (`a`) -> (Don't care)
        |a (`a`) -> (Don't care)
        |a (`a`) -> (Don't care)
        |a (`int a = 0`) -> (`l` (input), `m` (input), `n` (input))
        |a = (a + n) (`a = a + n`) -> (`R` in `UniqueNode(R = 0)`, `a` in `UniqueNode(a = (a + n))`, `a` in `UniqueNode(a = 0)`, `l` (input), `m` (input), `n` (input))
        |a = 0 (`int a = 0`) -> (`l` (input), `m` (input), `n` (input))
        |n (`n`) -> (Don't care)
        |n (`n`) -> (Don't care)""".stripMargin
    ...
    val test04ExpectedOutput =
      """(R + a) (`R + a`) -> (Don't care)
        ...
        |R (`R`) -> (Don't care)
        |R (`int R = 0`) -> (`a` in `UniqueNode(a = 0)`, `l` (input), `m` (input), `n` (input))
        |R = (R + a) (`R = R + a`) -> (`R` in `UniqueNode(R = 0)`, `a` in `UniqueNode(a = (a + n))`, `l` (input), `m` (input), `n` (input))
        |R = 0 (`int R = 0`) -> (`a` in `UniqueNode(a = 0)`, `l` (input), `m` (input), `n` (input))
        |a (`a`) -> (Don't care)
        |a (`a`) -> (Don't care)
        |a (`a`) -> (Don't care)
        |a (`int a = 0`) -> (`l` (input), `m` (input), `n` (input))
        |a = (a + n) (`a = a + n`) -> (`R` in `UniqueNode(R = 0)`, `a` in `UniqueNode(a = 0)`, `l` (input), `m` (input), `n` (input))
        |a = 0 (`int a = 0`) -> (`l` (input), `m` (input), `n` (input))
        |n (`n`) -> (Don't care)""".stripMargin
